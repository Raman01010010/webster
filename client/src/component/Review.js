...
const Review = (props) => {
  const { name, email, phone, place, resume, additionalQuestions, location } =
    props;
    ...
    <Container maxWidth="sm">
      <Card>
        <CardContent>
          ...
          <Typography variant="body2">Resume: {resume}</Typography>
          <Button
            variant="outlined"
            onClick={() => {
              setResumeDialogOpen(true);
          ...
          <FormControl component="fieldset">
            <FormLabel component="legend">
              ...
              local law/regulations?Are you willing to undergo a background
