...
exports.acceptrequest = async (req, res) => {
    try {
      ...
      await sendNotification(senderUser._id, `${receiverUser.username} accepted your connection request`, '', 'connect', res);
  ...
  exports.connection = async (req,res) =>{
   ...
   if(a.length==0){ 
    ...
    await sendNotification(receiverid, `${sender.username} sent you a friend request`, '', 'connect', res);
